...
@Controller
public class ChatTalkController extends BaseController{

    @RequestMapping("/demo")
    public String demo() throws Exception {
        System.out.println("======================================22222222222222222222222222===============================================");
        return "/pjsp/chatTalk";
    }
/*
    *//**
     * 检查session是否过期
    ...
    public String check(HttpServletResponse response) throws IOException {
        // 从session中获得用户的信息
        Map<String,Object> existUser= (Map<String, Object>) session.getAttribute("worker");
        // 判断session中的用户是否过期
        if(existUser == null){
            // 登录的信息已经过期了!
    ...
    *//**
    ...
    public String exit(HttpServletResponse response) throws IOException{
        ...
        session.invalidate();
        // 页面转向.
        response.sendRedirect(request.getContextPath()+"/chattalk11.jsp");
    ...
    *//**
     ...
     * @throws IOException
     *//*
    public String sendMessage(HttpServletResponse resp) throws IOException{
        // 1.接收数据 。
