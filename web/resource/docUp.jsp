                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" value="" name="hidUser2">
                                <input type="hidden" value="" id="hidUser" name="hidUser">
                            </td>
                        </tr>
                        <!-- 模态框（Modal） -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="show2()">关闭
                                        </button>
                                        <button type="button" class="btn btn-primary" onclick="show()" data-dismiss="modal" >提交更改
                                        </button>
                                    </div>
                                </div><!-- /.modal-content -->
                            </div><!-- /.modal -->
