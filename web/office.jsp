			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>会议管理</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>

							<div id="subPages" class="collapse ">
								<ul class="nav">

									<li><a tabindex="-1"  href="${pageContext.request.contextPath}/zw/seleratifymeeting.do;" target="right">已批准会议</a></li>

									<li><a tabindex="-1"  href="${pageContext.request.contextPath}/zw/showfinishmeeting.do;" target="right">未批准会议</a></li>

									<li><a tabindex="-1"  href="${pageContext.request.contextPath}/zw/showapproval.do;" target="right">待批准会议</a></li>

									<li><a tabindex="-1"  href="${pageContext.request.contextPath}/zw/showallmeeting.do;" target="right">会议室管理</a></li>

									<li><a tabindex="-1"  href="${pageContext.request.contextPath}/zwz/addmeetingroom.jsp;" target="right">会议室添加</a></li>
