    ...
    <div class="page-container">
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <c:forEach items="${noratifylist}" var="z" varStatus="i" >
...
<script type="text/javascript">
    ...
    function product_del(id){
        ...
        if(z){
            $.ajax({
                type: 'POST',
                url:'${pageContext.request.contextPath }/zw/deletemetting.do?id='+id

            });
            setTimeout(function(){
                self.location='${pageContext.request.contextPath }/zwz/finishmeeting.jsp';
            },350);
        }
    }
