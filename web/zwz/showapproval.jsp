    ...
    <div class="page-container">
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <c:forEach items="${awaitratify}" var="z" varStatus="i" >
                    <tr class="text-c va-m">
                        ...
                        <td class="td-manage">
                            ...
                            <a style="text-decoration:none" class="ml-5" onClick="product_edit('${z.id}')"   title="审批会议">
...
<script type="text/javascript">
    ...
    function product_edit(id){
        $.ajax({
            type: 'POST',
            url:'${pageContext.request.contextPath }/zw/showmeeting.do?id='+id
//

        });
        setTimeout(function(){
            self.location='${pageContext.request.contextPath }/zwz/meeting.jsp';
        },150);
