...
<div id="wrapper">
    ...
    <div class="content">
        <div class="container">
                            ...
                            <li><a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>考勤管理</span><i class="icon-submenu lnr lnr-chevron-left"></i> </a>
                                <div id="subPages" class="collapse ">
                                    <ul class="nav" id="menuSideBar">
                                        ...
                                        <li mid="tab1" funurl="${pageContext.request.contextPath}/resou/artile.do"><a tabindex="-1" href="javascript:void(0);">官方论坛</a></li>
                                        <li mid="tab1" funurl="${pageContext.request.contextPath}/resource/word.jsp"><a tabindex="-1" href="javascript:void(0);">我的发帖</a></li>
                                    </ul>
                                </div>
                            </li>
            ...
            <div style="border:2px solid blue;width:1640px;height:860px;position:relative;top:86px;left:-120px;">
